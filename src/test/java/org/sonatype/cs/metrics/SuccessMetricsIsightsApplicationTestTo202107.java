...
@SpringBootTest(properties = { "data.dir=src/test/resources", "spring.profiles.active=insights", "data.successmetrics=successmetrics-2021-01-01-to-2021-07-01.csv" }, webEnvironment = WebEnvironment.RANDOM_PORT)
