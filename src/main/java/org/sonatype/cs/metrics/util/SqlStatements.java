...
public class SqlStatements {
	...
	public static String QuarantinedComponents = "select repository as pointA, quarantine_date as pointB, date_cleared as pointC, " +
													"path_name as pointD, format as pointE, quarantined as pointF, policy_name as pointG, threat_level as pointH, cve as pointI " +
													"from QUARANTINED_COMPONENTS order by 6 asc";
	...
	public static String AutoReleasedFromQuarantinedComponents = 
							...
							"path_name as pointD, format as pointE, quarantined as pointF, policy_name as pointG, threat_level as pointH, cve as pointI " +
							"from AUTORELEASED_FROM_QUARANTINE order by 6 asc";
	...
	public static String QuarantinedComponentsTable = "DROP TABLE IF EXISTS QUARANTINED_COMPONENTS;" + 
				"CREATE TABLE QUARANTINED_COMPONENTS (" + 
				"  repository VARCHAR(250) NOT NULL," +
				"  quarantine_date VARCHAR(250) NOT NULL," + 
				"  date_cleared VARCHAR(250) DEFAULT NULL," + 
				"  path_name VARCHAR(250) DEFAULT NULL," +
				"  format VARCHAR(250) DEFAULT NULL," +
				"  quarantined VARCHAR(1024) DEFAULT NULL," +
				"  policy_name VARCHAR(250) DEFAULT NULL," +
				"  threat_level VARCHAR(250) DEFAULT NULL, " +
				"  cve VARCHAR(250) DEFAULT NULL) " +
				" AS SELECT repository, quarantine_date, date_cleared, path_name, format, quarantined, policy_name, threat_level, cve FROM CSVREAD ";

	public static String AutoreleasedFromQuarantinedComponentsTable = "DROP TABLE IF EXISTS AUTORELEASED_FROM_QUARANTINE;" + 
				"CREATE TABLE AUTORELEASED_FROM_QUARANTINE (" + 
				"  repository VARCHAR(250) NOT NULL," +
				"  quarantine_date VARCHAR(250) NOT NULL," + 
				"  date_cleared VARCHAR(250) DEFAULT NULL," + 
				"  path_name VARCHAR(250) DEFAULT NULL," +
