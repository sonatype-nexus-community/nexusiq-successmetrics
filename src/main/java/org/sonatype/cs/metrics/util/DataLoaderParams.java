...
public class DataLoaderParams {
	...
	public static final String qcompDatafile = "reports2/quarantined_data/quarantined_components.csv";
	...
	public static final String afqcomponentDatafile = "reports2/quarantined_data/autoreleased_from_quarantine_components.csv";
	...
	public static final String afqconfigDatafile = "reports2/quarantined_data/autoreleased_from_quarantine_config.csv";
	public static final String afqconfigHeader = "id,name,autoReleaseQuarantineEnabled";
	
	public static final String afqsDatafile = "reports2/quarantined_data/autoreleased_from_quarantine_summary.csv";
	public static final String qcsDatafile = "reports2/quarantined_data/quarantined_components_summary.csv";
