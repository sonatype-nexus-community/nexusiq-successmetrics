...
public final class FilenameInfo {
        ...
        public static final String QUARANTINED_COMPONENTS_SUMMARY_CSV_FILE = "quarantined_components_summary.csv";
        public static final String AUTO_RELEASED_FROM_QUARANTINE_COMPONENTS_CSV_FILE = "autoreleased_from_quarantine_components.csv";
        public static final String AUTO_RELEASED_FROM_QUARANTINE_SUMMARY_CSV_FILE = "autoreleased_from_quarantine_components_summary.csv";
        public static final String AUTO_RELEASED_FROM_QUARANTINE_CONFIG_CSV_FILE = "autoreleased_from_quarantine_config.csv";
